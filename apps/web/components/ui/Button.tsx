    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-[#1E2A78] text-white hover:bg-[#162056] focus:ring-[#1E2A78]":
              variant === "primary",
            "bg-[#F4B400] text-[#111827] hover:bg-[#D99F00] focus:ring-[#F4B400]":
              variant === "secondary",
            "border-2 border-[#1E2A78] text-[#1E2A78] hover:bg-[#1E2A78] hover:text-white focus:ring-[#1E2A78]":
              variant === "outline",

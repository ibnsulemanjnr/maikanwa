...
const menuItems = [
  ...
  { href: '/admin/tailoring', label: 'Tailoring', icon: 'M14.121 14.121L19 19m-7-7l7-7m-7 7l-2.879 2.879M12 12L9.121 9.121m0 5.758a3 3 0 10-4.243 4.243 3 3 0 004.243-4.243zm0-5.758a3 3 0 10-4.243-4.243 3 3 0 004.243 4.243z' },
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-white border-r border-[#E5E7EB] min-h-screen">
      <div className="p-6 border-b border-[#E5E7EB]">
        <Link href="/admin" className="flex items-center space-x-2">
          <div className="w-8 h-8 bg-[#1E2A78] rounded-lg flex items-center justify-center">
            <span className="text-white font-bold text-lg">M</span>
          </div>
          <span className="text-xl font-bold text-[#1E2A78]">Admin</span>
        </Link>
      </div>
      ...
      <div className="absolute bottom-0 w-64 p-4 border-t border-[#E5E7EB]">
        <Link
          href="/"
